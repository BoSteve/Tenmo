...
public class App {
	...
	private void sendBucks() {
		...
		System.out.println(transferServices.createTransfer(userToId, transferAmount));
	...
	private void requestBucks() {
		...
		displayRegisteredUsers();
		String choice = (String) console.getUserInput("\nEnter ID of user you are requesting money from (0 to cancel): " );
		while (!choice.equals("0")) {
		userFromId = (Long.parseLong(choice));
		choice = (String) console.getUserInput("\nEnter amount");
		transferAmount = (new BigDecimal(choice).setScale(2, RoundingMode.HALF_UP));
		System.out.println(transferServices.createTransfer(userFromId, transferAmount));
		choice = (String) console.getUserInput("\nEnter another ID of user if you would like to send more TE Bucks (0 to cancel): " );
		}
	}
